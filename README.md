...
[![GoDoc](https://godoc.org/github.com/alphaticks/machineid?status.svg)](https://godoc.org/github.com/alphaticks/machineid) [![Go Report Card](https://goreportcard.com/badge/github.com/alphaticks/machineid)](https://goreportcard.com/report/github.com/alphaticks/machineid)
...
```bash
go get github.com/alphaticks/machineid
```

You can also add the cli app directly to your `$GOPATH/bin` with

```bash
go get github.com/alphaticks/machineid/cmd/machineid
```
